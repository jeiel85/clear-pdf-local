...
- **AI 곡면 보정 / 책 펴기 (Neural Dewarping)**: 펼친 책처럼 휘어진 페이지를 찍어도, 스캔한 페이지의 'Flatten' 메뉴로 굽은 글줄과 책등 곡률을 평평하게 펴냅니다. UVDoc 모델을 ONNX Runtime으로 **온디바이스 실행**(중급 태블릿에서 ~0.3초)하며, 모델이 앱에 번들되어 인터넷 없이 동작합니다.
